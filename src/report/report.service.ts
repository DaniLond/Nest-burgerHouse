...
export class ReportService {
  ...
  async getWeeklySalesReport(date: Date = new Date()) {
    ...
    return this.getSalesReport(startOfWeek, endOfWeek);
  }
  ...
  async getDailyTopSellingProducts(date: Date = new Date(), limit: number = 10) {
    const startOfDay = moment(date).startOf('day').toDate();
    const endOfDay = moment(date).endOf('day').toDate();
  ...
  async getWeeklyTopSellingProducts(date: Date = new Date(), limit: number = 10) {
    const startOfWeek = moment(date).startOf('week').toDate();
    const endOfWeek = moment(date).endOf('week').toDate();
  ...
  async getMonthlyTopSellingProducts(date: Date = new Date(), limit: number = 10) {
    const startOfMonth = moment(date).startOf('month').toDate();
    const endOfMonth = moment(date).endOf('month').toDate();
